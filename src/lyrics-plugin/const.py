...
class Constant(object):
    if "XDG_CONFIG_HOME" in os.environ:
        conf_dir = os.path.join(os.environ["XDG_CONFIG_HOME"], "cloudmusic-api")
    else:
        conf_dir = os.path.join(os.path.expanduser("~"), ".cloudmusic-api")
    config_path = os.path.join(conf_dir, "config.json")
    if "XDG_CACHE_HOME" in os.environ:
        cacheDir = os.path.join(os.environ["XDG_CACHE_HOME"], "cloudmusic-api")
    ...
    if "XDG_DATA_HOME" in os.environ:
        dataDir = os.path.join(os.environ["XDG_DATA_HOME"], "cloudmusic-api")
